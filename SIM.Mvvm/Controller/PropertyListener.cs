...
namespace SIM.Mvvm
{
    ...
    internal class PropertyListener<T, TProperty> : IPropertyListener, IPropertyListener<TProperty>, IDisposable
        where T : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyListener{T, TProperty}"/> class.
        /// </summary>
        ...
        public PropertyListener(T source, string propertyName, Func<T, TProperty> propertyGetter)
        {
            this.source = source;
